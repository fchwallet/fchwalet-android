...
public class UtxoTask extends AsyncTask<String, Integer, String> {

    public static final String TAG = "UtxoTask";
    public static final String PREURL = "http://47.244.146.150:8422/api/utxo/findUtxoByAddress?address=";

    private Context mContext;
    private String mUrl;

    public UtxoTask(Context ctx, String address) {
        mContext = ctx;
        mUrl = PREURL + address;
    }
    ...
    protected void onPostExecute(String utxo) {
        if (utxo != null && utxo != "") {
            ...
            i.setAction(HomeActivity.ACTION_UTXO_UPDATE);
